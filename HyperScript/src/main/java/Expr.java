...
abstract class Expr {
    ...
    // --- New & Upgraded Expression Classes ---
    ...
    static class Call extends Expr {
        ...
        Call(Expr callee, Token paren, List<Expr> arguments) { this.callee = callee; this.paren = paren; this.arguments = arguments; }
