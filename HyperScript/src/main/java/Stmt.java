...
abstract class Stmt {
    ...
    // --- New & Upgraded Statement Classes ---
    ...
    static class Function extends Stmt {
        ...
        Function(Token name, List<Token> params, List<Stmt> body) { this.name = name; this.params = params; this.body = body; }
